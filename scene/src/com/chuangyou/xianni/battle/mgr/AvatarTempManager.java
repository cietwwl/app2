...
//		}
	...
	// public static AvatarStarTemplate getAvatarStarTemplate(int tempId, int
	// starLv) {
	...
	// }
	//
	// public static AvatarUpGradeTemplate getAvatarUpGradeTemplate(int tempId,
	// int grade) {
	// Map<Integer, AvatarUpGradeTemplate> gradeTemps =
	// avatarUpGradeTemps.get(tempId);
	// if (gradeTemps != null) {
