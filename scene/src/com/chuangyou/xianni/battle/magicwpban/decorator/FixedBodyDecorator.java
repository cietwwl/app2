...
public class FixedBodyDecorator extends MagicwpBanBaseDecorator {
	static final int	BUFFER_ID	= 70001;
	private int			fixTime;

	public FixedBodyDecorator(Player master, int level) {
		super(master, level, MagicwpBanConstant.FIXED_BODY);
