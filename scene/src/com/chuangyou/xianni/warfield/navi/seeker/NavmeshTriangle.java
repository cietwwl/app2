...
public class NavmeshTriangle {
	 ...
	 * 3D世界坐标点
	 */
	protected com.chuangyou.common.util.Vector3[]	_points3D;
	...
	public NavmeshTriangle(int id, Vector3 pos1, Vector3 pos2, Vector3 pos3) {
		...
		_wallDistance[0] = Math
				.sqrt((wallMidPoint[0].x - wallMidPoint[1].x) * (wallMidPoint[0].x - wallMidPoint[1].x) + (wallMidPoint[0].y - wallMidPoint[1].y) * (wallMidPoint[0].y - wallMidPoint[1].y));
		_wallDistance[1] = Math
				.sqrt((wallMidPoint[1].x - wallMidPoint[2].x) * (wallMidPoint[1].x - wallMidPoint[2].x) + (wallMidPoint[1].y - wallMidPoint[2].y) * (wallMidPoint[1].y - wallMidPoint[2].y));
		_wallDistance[2] = Math
				.sqrt((wallMidPoint[2].x - wallMidPoint[0].x) * (wallMidPoint[2].x - wallMidPoint[0].x) + (wallMidPoint[2].y - wallMidPoint[0].y) * (wallMidPoint[2].y - wallMidPoint[0].y));
		// 计算包围盒
		calcCollider();
	}
