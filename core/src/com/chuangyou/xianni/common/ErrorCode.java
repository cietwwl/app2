...
public class ErrorCode {
	...
	/** 服务器已存在 */
	public final static int SERVER_IS_ALREADY_EXISTS = 101;

	/** 服务器未注册或已失效 */
	public final static int SERVER_IS_NOT_REGISTER_OR_ALEREADY_INVALID = 102;

	/** 获取场景服务器失败 **/
	public final static int GET_SCENE_SERVER_FAIL = 103;

	/** 角色名重复 */
	public final static int PlayerName_IS_ALREADY_EXISTS = 201;

	/** 用户名不存在或密码不正确 */
	public final static int USERNAME_OR_PWD_IS_NOT_CORRECT = 202;
	...
	/** 角色不在地图上 */
	public final static int ROLE_NOT_IN_MAP = 205;

	/** 角色挂了 */
	public final static int ROLE_IS_DEAD = 206;
