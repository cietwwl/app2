...
import com.chuangyou.common.protobuf.pb.npcDialog.NpcDialogSelectReqProto.NpcDialogSelectReqMsg;
...
@Cmd(code=Protocol.C_REQ_NPCDIALOGSELECT,desc="选择NPC选项回应")
public class NpcDialogSelectCmd extends AbstractCommand {

	@Override
	public void execute(GamePlayer player, PBMessage packet) throws Exception {
		// TODO Auto-generated method stub
		NpcDialogSelectReqMsg req = NpcDialogSelectReqMsg.parseFrom(packet.getBytes());
		int npcid = req.getNpcType();
		int commandParam = req.getCommandParam();
