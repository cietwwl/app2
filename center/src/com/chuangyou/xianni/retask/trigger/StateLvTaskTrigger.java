 ...
 *
 */
public class StateLvTaskTrigger extends BaseTaskTrigger implements ITaskInitBehavior {

	public StateLvTaskTrigger(GamePlayer player, ITask task) {
		super(player, task);
			...
			public void onEvent(ObjectEvent event) {
				...
				if(map!=null){
					for(Map.Entry<Integer, Long> entry:map.entrySet()){
						if(entry.getKey() == EnumAttr.State.getValue()){
	...
	public void initTask() {
		// TODO Auto-generated method stub		
		getTask().getTaskInfo().setProcess(player.getBasePlayer().getPlayerInfo().getStateLv());
	}
}
