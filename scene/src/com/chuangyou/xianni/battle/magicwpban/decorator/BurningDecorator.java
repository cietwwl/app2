...
public class BurningDecorator extends MagicwpBanBaseDecorator {
	private int damagePercent;

	public BurningDecorator(Player master, int level) {
		super(master, level, MagicwpBanConstant.BURNING);
		damagePercent = Math.min(5000 + (level - 1) * 500, 12500);
	}
