...
public class SkillPropertyTemplateInfoDaoImpl extends BaseDao implements SkillPropertyTemplateInfoDao {
	...
	public List<SkillPropertyTemplateInfo> load() {
		...
		ResultSet rs = null;
		List<SkillPropertyTemplateInfo> list = new ArrayList<SkillPropertyTemplateInfo>();
		if (pstmt != null) {
			try {
				rs = pstmt.executeQuery();
				while (rs.next()) {
					SkillPropertyTemplateInfo skillPropertyTemplateInfo = new SkillPropertyTemplateInfo();
