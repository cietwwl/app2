...
public class MagicwpRefineManager {
	...
	/**
	 * 计算洗炼法宝属性结果
	 * @param gradeCfg 当前当宝等阶配置，取当前阶属性上限
	 * @param curAttMap 传入法宝当前洗炼属性
	 * @param refineCfg 当前法宝洗炼属性区间配置
	 * @param lockList 已经锁定属性类型列表
	 * @return
	 */
	public static Map<Integer, Integer> getRefineResultMap(MagicwpGradeCfg gradeCfg, Map<Integer, Integer> curAttMap,
			MagicwpRefineCfg refineCfg, List<Integer> lockList) {
