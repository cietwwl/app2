...
public class PetQualityCfg {
	...
	public void setAttPer(short attPer) {
		this.attPer = attPer;
	}
	@Override
	public String toString() {
		return "PetQuality [id=" + id + ", lv=" + lv + ", needItem=" + needItem + ", needNum=" + needNum + ", proMax="
				+ proMax + ", rate=" + rate + ", att1=" + att1 + ", att2=" + att2 + ", att3=" + att3 + ", att4=" + att4
				+ ", att5=" + att5 + ", att6=" + att6 + ", att7=" + att7 + ", att8=" + att8 + ", attPer=" + attPer
				+ "]";
	}
}
