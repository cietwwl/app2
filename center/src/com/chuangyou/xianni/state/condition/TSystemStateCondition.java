...
public class TSystemStateCondition extends BaseStateCondition {

	public TSystemStateCondition(StateConditionInfo info, StateConditionConfig config, GamePlayer player) {
