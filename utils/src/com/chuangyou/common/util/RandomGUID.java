...
/**
 * Use Exceple public static void main(String args[]) { for (int i=0; i< 100; i++) { GuidCreator myGUID = new GuidCreator(); System.out.println(”Seeding String=” + myGUID.getNewGuid(GuidCreator.BeforeMD5)); System.out.println(”rawGUID=” + myGUID.getNewGuid(GuidCreator.AfterMD5)); System.out.println(”RandomGUID=” + myGUID.getNewGuid(GuidCreator.FormatString)); } }
 */
