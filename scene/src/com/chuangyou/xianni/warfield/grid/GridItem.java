...
//			if(living.getId() < 200)
//				System.err.println("addLiving - " + living.getId() + " id = " + id+ " contianer.size() = " + contianer.size());
	...
	public void removeLiving(Living living)
	{
		synchronized (livings) {
			...
			List<Long> contianer = livings.get(living.getType());
//			if(living.getId() < 200)
//				System.err.println("removeLiving - " + living.getId() + " id = " + id + " contianer.size() = " + contianer.size());
