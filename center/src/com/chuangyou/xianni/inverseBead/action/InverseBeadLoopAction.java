...
//	public static int		intervalTime	= 1000;	// 下一次时间
...
//			//Log.error("intervalTime :" + intervalTime);
//			getActionQueue().enDelayQueue(this);
//		}
//		//Log.error("exe loop : " + (System.currentTimeMillis() - now) + " playerId :" + player.getPlayerId());
//	}
//
//	/**
//	 * 获取间隔时间
